...
class AccontPaymentWizard(models.Model):
    ...
    amount_residual = fields.Monetary(
        string='Amount Due', store=True, readonly=True, related="move_id.amount_residual")
        ...
        for payment in self:
            ...
            if payment.payment_id.currency_id != payment.currency_id:
                amount_to_pay = payment.currency_id._convert(
                    payment.amount_to_pay, payment.payment_id.currency_id, payment.company_id, date)
            else:
