...
class ImportLots(http.Controller):
    ...
    @http.route('/download/excel2', type='http', auth="user")
    def download_excel_file2(self):
        ...
        # Add sample data
        data = [
            ('10251', 'ABRAHAM LEAL BECERRIL'),
            ('11140', 'ABRAHAM OLMOS RODRIGUEZ'),
            ('10709', 'ABRAHAM SOTELO RAMIREZ'),
        ]
        for row in data:
            ws.append(row)
