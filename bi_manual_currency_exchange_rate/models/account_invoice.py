...
class stock_move(models.Model):
    ...
    def _get_price_unit(self):
        """ Refactorizado por conflicto con el modulo nativo de odoo, ademas esta en deshuso porque el precio se toma de la linea de pedido de compra o venta, segun corresponda, y no del costo del producto"""
