...

{
    ...
    ''',
    'author': 'BROWSEINFO',
    'website':'https://www.browseinfo.com/demo-request?app=bi_website_shop_product_filter&version=18&edition=Community',
    'price': 29,
    'currency': 'EUR',
    'depends': ['base', 'sale_management', 'product', 'website', 'website_sale', 'test_sale_product_configurators'],
    'data': [
    ...
    'installable': True,
    'license': 'OPL-1',
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_website_shop_product_filter&version=18&edition=Community',
